...
The most important parts to remember are meaning and reading. If you don't understand the meaning you mined then read through the example sentence.
For every card in Anki you learn one meaning (and reading) depending on the language at a time. 
