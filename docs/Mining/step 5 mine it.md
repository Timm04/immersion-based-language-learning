...
graph LR
  ...
  with what you have looked up in mind] ----> E{Do I understand ?} -->|Yes| F[Mine it]
```

Conditions you must fullfil to mine a word:
...
- Gone through steps 1-4
- Don't mine things you don't understand
- Don't mine things from sentences you don't understand
- If a word has multiple definitions, only mine the definition that is used in your sentence.
- Avoid mining high frequencies words unless they interest you personally
